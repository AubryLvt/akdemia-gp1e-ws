...
//
//    @DeleteMapping("/{id}")
//    public ResponseEntity<Void> deleteUser(@PathVariable Integer id) throws AkdemiaBusinessException {
...
//	@PutMapping("/pwd/{id}")
//	public ResponseEntity<UserBasicDTO> updatepwd(@PathVariable int id, @RequestBody UserBasicDTO dto) throws CustomException{
//		UserBasicDTO basicDTO = userService.updatePwd(dto);
